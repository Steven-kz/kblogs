import{_ as i,r as p,o,c as l,a as n,b as s,d as t,f as a}from"./app-cc861b06.js";const r={},c=a(`<h2 id="一、安装配置" tabindex="-1"><a class="header-anchor" href="#一、安装配置" aria-hidden="true">#</a> 一、安装配置</h2><div class="hint-container tip"><p class="hint-container-title">提示</p><p>此教学为Jenkins新版本 需JDK11进行运行</p></div><h3 id="_1-1-安装jdk" tabindex="-1"><a class="header-anchor" href="#_1-1-安装jdk" aria-hidden="true">#</a> 1.1 安装JDK</h3><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code># 服务器使用jdk8
