import{_ as i,r as l,o as c,c as p,a as s,b as n,d as e,f as t}from"./app-942d725a.js";const o={},r=t(`<h2 id="一、docker安装es" tabindex="-1"><a class="header-anchor" href="#一、docker安装es" aria-hidden="true">#</a> 一、Docker安装ES</h2><p>注：<strong>elasticsearch + kibana + ik 版本一致</strong></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 1.拉取镜像</span>
