import{_ as i,r as l,o as r,c as d,a as n,b as s,d as a,f as c}from"./app-942d725a.js";const t={},o={href:"https://redis.io/downloads/",target:"_blank",rel:"noopener noreferrer"},p=n("br",null,null,-1),v={href:"https://download.redis.io/releases/",target:"_blank",rel:"noopener noreferrer"},m=n("br",null,null,-1),u=n("code",null,"Redis6.0",-1),b=n("code",null,"gcc版本升级到5.3以上",-1),k=n("code",null,"gcc",-1),g=n("code",null,"4.8.5",-1),h=n("code",null,"gcc",-1),f=c(`<h2 id="一、安装redis" tabindex="-1"><a class="header-anchor" href="#一、安装redis" aria-hidden="true">#</a> 一、安装Redis</h2><div class="language-powershell line-numbers-mode" data-ext="powershell"><pre class="language-powershell"><code>cd <span class="token operator">/</span>usr/local
