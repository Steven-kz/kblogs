import{_ as i,r as l,o as p,c,a as n,b as s,d as t,f as a}from"./app-8ab1e15b.js";const o={},r=a(`<h2 id="一、jdk安装" tabindex="-1"><a class="header-anchor" href="#一、jdk安装" aria-hidden="true">#</a> 一、JDK安装</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">cd</span> /usr/local
